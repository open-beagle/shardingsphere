...
/**
 * Schema metadata loader for oscar. by wuwanli
 */
@Slf4j
public final class OscarSchemaMetaDataLoader implements DialectSchemaMetaDataLoader {
    ...
    private Map<String, Collection<ColumnMetaData>> loadColumnMetaDataMap(final Connection connection, final Collection<String> tables) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(getTableMetaDataSQL(tables, connection.getMetaData()))) {
            ...
            dataTypes = getDataTypes(dataTypes);
    ...
    private Map<String, Integer> getDataTypes(final Map<String, Integer> dataTypes) {
        ...
        result.put("IMAGE", Types.LONGVARBINARY);
