...
/**
 * Data source metadata for oscar. by wuwanli
 */
@Getter
public final class OscarDataSourceMetaData implements DataSourceMetaData {
    ...
    public OscarDataSourceMetaData(final String url, final String username) {
