...
/**
 * XA connection wrapper for GBase. by wuwanli
 */
public final class GBaseXAConnectionWrapper implements XAConnectionWrapper {
    ...
    private Class<Connection> getJDBCConnectionClass() {
        return (Class<Connection>) Class.forName("com.gbasedbt.jdbc.IfxSqliConnect");
    }

    @SneakyThrows(ReflectiveOperationException.class)
    private Constructor<?> getXAConnectionConstructor() {
        return Class.forName("com.gbasedbt.jdbc.IfxSqliConnect").getConstructor(Class.forName("com.gbasedbt.jdbc.IfxSqliConnect"));
    }
