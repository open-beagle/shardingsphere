...
/**
 * XA connection wrapper for oscar. by wuwanli
 */
public final class OscarXAConnectionWrapper implements XAConnectionWrapper {
    ...
    private Class<Connection> getJDBCConnectionClass() {
        return (Class<Connection>) Class.forName("com.oscar.xa.Jdbc3XAConnection");
    }

    @SneakyThrows(ReflectiveOperationException.class)
    private Constructor<?> getXAConnectionConstructor() {
        return Class.forName("com.oscar.xa.Jdbc3XAConnection").getConstructor(Class.forName("com.oscar.xa.Jdbc3XAConnection"));
    }
